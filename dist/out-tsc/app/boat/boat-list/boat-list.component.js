...
var BoatListComponent = (function () {
    function BoatListComponent(boatService) {
        this.boatService = boatService;
    }
    BoatListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.boatService.getBoats()
            .subscribe(function (boats) { return _this.boats = boats; }, function (error) { return console.log(error); });
...
exports.BoatListComponent = BoatListComponent;
//# sourceMappingURL=E:/wamp64/www/frontStarter/src/app/boat/boat-list/boat-list.component.js.map